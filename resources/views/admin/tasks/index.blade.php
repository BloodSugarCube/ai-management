    ...
    <div id="recModal" class="modal" role="dialog" aria-modal="true" aria-labelledby="recModalTitle">
        <header>
            <div class="wrap modal-head">
                <div id="recModalTitle" class="modal-title">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 11l-4 4-2-2"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    <span>Рекомендации исполнителей</span>
                </div>
                <button type="button" class="x x-lg" id="modalCloseX" aria-label="Закрыть">×</button>
            </div>
        </header>
